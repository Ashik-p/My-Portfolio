          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {skillCategories.map((category, index) => (
              ...
              >
                ...
                <div className="space-y-3 max-h-0 opacity-0 transform-gpu transition-all duration-700 ease-out group-hover:max-h-[500px] group-hover:opacity-100 overflow-hidden">
